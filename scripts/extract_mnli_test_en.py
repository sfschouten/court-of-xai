...
if __name__ == "__main__":
    in_test_path = os.path.abspath('ane_research/datasets/MNLI/xnli.test.jsonl')
    out_test_path = os.path.abspath('ane_research/datasets/MNLI/multinli_1.0_test.jsonl')
